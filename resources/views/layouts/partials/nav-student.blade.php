<header class="bg-white dark:bg-slate-800 border-b border-slate-200 dark:border-slate-700 shadow-sm sticky top-0 z-50 transition-colors duration-300">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="flex justify-between h-20">
            ...
            <div class="flex items-center gap-4">
                ...
                <a href="{{ route('profile') }}" class="text-right hidden sm:block border-r border-slate-200 dark:border-slate-600 pr-4 hover:opacity-80 transition-opacity">
