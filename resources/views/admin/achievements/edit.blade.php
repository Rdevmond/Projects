...
<div class="max-w-4xl mx-auto py-10 transition-colors">
 ...
 class="w-full px-6 py-4 rounded-2xl border-2 border-slate-50 dark:border-slate-800 bg-slate-50 dark:bg-slate-800/50 focus:bg-white dark:focus:bg-slate-800 focus:border-[#00bceb] outline-none transition font-bold text-slate-700 dark:text-slate-200">{{ $achievement->content }}</textarea>
 </div>

 <div class="flex items-center gap-3 transition-colors">
 <input type="checkbox" name="is_active" value="1" id="is_active" {{ $achievement->is_active ? 'checked' : '' }} class="w-5 h-5 rounded-lg text-[#005073] dark:text-[#00bceb] transition">
