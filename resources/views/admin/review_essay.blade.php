...
<div class="max-w-4xl mx-auto py-8">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
            <a href="{{ url()->previous() }}" class="text-[#00bceb] font-bold text-sm hover:text-[#005073] dark:hover:text-white transition flex items-center gap-2 transition-colors">
                        ...
                        <div class="flex items-center gap-4 p-5 bg-[#eefbff] dark:bg-[#00bceb]/10 rounded-2xl border border-[#00bceb]/20 dark:border-[#00bceb]/30 transition-colors">
                            ...
                            <div class="relative">
                                <input type="number" name="manual_points" value="0" min="0" max="1"
                                    class="w-24 p-4 rounded-xl border-2 border-[#00bceb]/30 dark:border-[#00bceb]/50 focus:border-[#005073] dark:focus:border-[#00bceb] focus:ring-4 focus:ring-[#00bceb]/10 bg-white dark:bg-slate-800 text-center text-xl font-black text-[#005073] dark:text-white outline-none transition-all transition-colors">
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="bg-slate-50 dark:bg-slate-800 rounded-[2.5rem] p-8 shadow-2xl shadow-slate-200/50 dark:shadow-black/40 border border-slate-200 dark:border-slate-700 relative overflow-hidden transition-colors duration-300">
                ...
                <div class="mb-6 relative z-10 transition-colors">
                    ...
                    <textarea name="feedback" rows="3"
                        class="w-full bg-slate-50 dark:bg-white/5 border border-slate-200 dark:border-white/10 rounded-2xl p-4 text-slate-700 dark:text-white outline-none focus:border-[#00bceb] focus:bg-white dark:focus:bg-white/10 transition placeholder-slate-400 dark:placeholder-white/20 font-medium transition-colors"
                        placeholder="Write a professional feedback note here..."></textarea>
                </div>

                <button type="submit" class="w-full bg-[#E2231A] hover:bg-[#E2231A] text-white font-black py-5 rounded-2xl shadow-xl shadow-[#E2231A]/30 dark:shadow-none transition transform hover:scale-[1.02] active:scale-95 uppercase tracking-[0.2em] text-sm relative z-10 transition-colors">
