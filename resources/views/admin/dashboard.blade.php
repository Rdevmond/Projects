...
<div class="bg-white dark:bg-slate-800 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm overflow-hidden transition-colors" x-data="{ deleteModalOpen: false, deleteAction: '' }">
    ...
    <tr class="hover:bg-[#eefbff]/50 dark:hover:bg-slate-700/50 transition group transition-colors">
        <td class="px-6 py-5">
            <div class="font-bold text-slate-700 dark:text-slate-200 group-hover:text-[#005073] dark:group-hover:text-[#00bceb] transition-colors transition-colors">{{ $exam->title }}</div>
        ...
        <td class="px-6 py-5 text-center" x-data="{ 
            ...
            <button @click="toggle()" :disabled="isLoading"
                class="group relative inline-flex items-center gap-2 px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest transition-all border transition-colors"
                :class="status === 'active' 
        ...
        <td class="px-6 py-5 text-right">
            <div class="flex justify-end items-center gap-2">
                ...
                <a href="{{ route('admin.specs', $exam) }}"
                   class="p-2.5 bg-slate-50 dark:bg-slate-900 hover:bg-[#005073] dark:hover:bg-[#00bceb] text-slate-500 dark:text-slate-400 hover:text-white rounded-xl transition-all border border-slate-100 dark:border-slate-800 transition-colors"
                ...
                <a href="{{ route('submissions.index', $exam) }}"
                   class="relative p-2.5 bg-slate-50 dark:bg-slate-900 hover:bg-[#005073] dark:hover:bg-[#00bceb] text-slate-500 dark:text-slate-400 hover:text-white rounded-xl transition-all border border-slate-100 dark:border-slate-800 transition-colors"
                ...
                <a href="{{ route('admin.exams.edit', $exam) }}"
                   class="p-2.5 bg-slate-50 dark:bg-slate-900 hover:bg-[#00bceb] text-slate-500 dark:text-slate-400 hover:text-white rounded-xl transition-all border border-slate-100 dark:border-slate-800 transition-colors"
                   title="Edit Exam">
                ...
                <button type="button" @click="deleteModalOpen = true; deleteAction = '{{ route('admin.exams.destroy', $exam) }}'"
                    class="p-2.5 bg-slate-50 dark:bg-slate-900 hover:bg-[#E2231A] text-slate-500 dark:text-slate-400 hover:text-white rounded-xl transition-all border border-slate-100 dark:border-slate-800 transition-colors" title="Delete Exam">
