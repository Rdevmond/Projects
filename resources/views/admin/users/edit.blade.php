...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 py-12 px-6 transition-colors duration-500" x-data="{ showPassword: false }">
 ...
 <div class="relative group">
  <div class="h-24 w-24 rounded-3xl flex items-center justify-center text-white font-black text-3xl shadow-2xl relative overflow-hidden ring-4 ring-white dark:ring-slate-800 border border-slate-200 dark:border-slate-700" 
