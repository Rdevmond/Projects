...
<div class="max-w-5xl mx-auto py-8">
    ...
    <div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
        <div>
            <a href="{{ route('admin.dashboard') }}" class="text-[#00bceb] font-bold text-sm hover:text-[#005073] dark:hover:text-white transition flex items-center gap-2 transition-colors">
