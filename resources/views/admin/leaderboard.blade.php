...
<div class="mb-8 flex flex-col md:flex-row justify-between items-start md:items-center gap-4 transition-colors">
 ...
 <a href="{{ route('admin.dashboard') }}" class="bg-white dark:bg-slate-900 border border-slate-200 dark:border-slate-800 text-[#005073] dark:text-[#00bceb] px-6 py-3 rounded-2xl font-bold shadow-sm hover:bg-slate-50 dark:hover:bg-slate-800 transition flex items-center gap-2">
 ⬅️ Back to Dashboard
 </a>
 </div>
</div>
