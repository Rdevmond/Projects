...
<div class="mb-8 flex justify-between items-end">
 ...
 class="flex items-center gap-2 px-6 py-3 bg-[#005073] dark:bg-[#00bceb] text-white dark:text-slate-900 rounded-2xl font-bold text-xs hover:bg-[#003d58] dark:hover:bg-[#008ebb] transition shadow-lg shadow-blue-100 dark:shadow-none uppercase tracking-widest">
