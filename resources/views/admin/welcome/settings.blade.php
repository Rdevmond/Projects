...
<div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100 dark:from-slate-900 dark:to-slate-950 py-12 px-6 transition-colors duration-500" x-data="cmsSettings()">
 ...
 <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-[3rem] shadow-2xl border border-white/60 dark:border-slate-700 p-10 md:p-14 transition-colors">
 <h3 class="text-2xl font-black text-[#005073] dark:text-white mb-8 flex items-center gap-3 transition-colors">
 <div class="h-12 w-12 rounded-2xl flex items-center justify-center text-2xl" style="background: linear-to-br from-[#005073] 0%, #00bceb 100%;">ðŸ“Š</div>
 Stats & Badges
 </h3>
 ...
 <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-[3rem] shadow-2xl border border-white/60 dark:border-slate-700 p-10 md:p-14 transition-colors">
 <h3 class="text-2xl font-black text-[#005073] dark:text-white mb-8 flex items-center gap-3 transition-colors">
 <div class="h-12 w-12 rounded-2xl flex items-center justify-center text-2xl" style="background: linear-to-br from-[#005073] 0%, #00bceb 100%;">ðŸ¤</div>
 About Section
 </h3>
 ...
 <input type="text" name="activity_{{ $i }}_icon" value="{{ $settings['activity_'.$i.'_icon'] ?? 'ðŸ†' }}" maxlength="2"
 ...
 <div class="bg-white/80 dark:bg-slate-800/80 backdrop-blur-xl rounded-[3rem] shadow-2xl border border-white/60 dark:border-slate-700 p-10 md:p-14 transition-colors">
 <h3 class="text-2xl font-black text-[#005073] dark:text-white mb-8 flex items-center gap-3 transition-colors">
 <div class="h-12 w-12 rounded-2xl flex items-center justify-center text-2xl" style="background: linear-to-br from-[#005073] 0%, #00bceb 100%;">ðŸŽ¨</div>
