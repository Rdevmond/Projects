...
<div x-data="examBuilder({{ $allStudents->toJson() }}, {{ json_encode($assignedUserIds) }})" class="max-w-5xl mx-auto py-12 px-4 transition-colors">
    <form action="{{ isset($exam) ? route('admin.exams.update', $exam) : route('admin.exams.store') }}"
        ...
        <template x-for="(question, index) in questions" :key="question.id">
            <div class="bg-white dark:bg-slate-800 rounded-[2.5rem] shadow-sm border border-slate-200 dark:border-slate-700 mb-8 overflow-hidden transition-all hover:shadow-xl dark:hover:shadow-none duration-300 ease-in-out"
                ...
                <div class="p-8 pb-4">
                    ...
                    {{-- Row 2: Context Image Attachment --}}
                    <div class="mt-6 flex flex-wrap items-center gap-4" x-data="{ preview: null }">
                        <label class="inline-flex items-center gap-3 px-4 py-2 bg-slate-100 dark:bg-slate-900 hover:bg-slate-200 dark:hover:bg-slate-700 text-[#005073] dark:text-[#00bceb] rounded-xl text-[10px] font-black cursor-pointer transition-all border border-slate-200 dark:border-slate-700 transition-colors">
                        ...
                        <div class="relative" x-show="preview || question.context_image_path">
                            ...
                            <button type="button" @click="preview = null; question.context_image_path = null"
                                    class="absolute -top-2 -right-2 bg-[#E2231A] text-white rounded-full p-1 shadow-lg hover:scale-110 transition-transform transition-colors">
                ...
                <div class="px-8 pb-8 pt-2">
                    <div class="bg-slate-50 dark:bg-slate-900/50 rounded-4xl border-2 border-slate-100 dark:border-slate-700/50 p-6 shadow-inner transition-colors">
                            ...
                            <template x-for="(opt, optIndex) in question.options" :key="optIndex">
                                <div class="flex items-center gap-4 bg-white dark:bg-slate-800 p-3 rounded-2xl border border-slate-200 dark:border-slate-700 shadow-sm group hover:border-[#00bceb]/50 transition-colors" x-data="{ optPreview: null }">
                                    ...
                                    <div class="flex items-center gap-3 pr-2">
                                        ...
                                        <label class="p-2 text-slate-400 dark:text-slate-600 hover:text-[#005073] dark:hover:text-[#00bceb] cursor-pointer transition-all bg-slate-50 dark:bg-slate-900 rounded-lg transition-colors">
                        ...
                        <div x-show="question.type === 'essay'" class="text-center py-6 bg-white/50 dark:bg-slate-800/50 rounded-2xl border-2 border-dashed border-slate-200 dark:border-slate-700">
                            ...
                            <label class="inline-flex items-center gap-3 px-6 py-3 bg-[#005073] dark:bg-[#00bceb] text-white dark:text-slate-900 rounded-xl shadow-lg dark:shadow-none cursor-pointer hover:bg-[#E2231A] dark:hover:bg-[#008ebb] transition-all transition-colors">
                    ...
                    <div class="flex items-center gap-4">
                        ...
                        <div class="flex items-center bg-white dark:bg-slate-800 rounded-lg p-1 border border-slate-200 dark:border-slate-700 transition-colors">
                            <button type="button" @click="moveUp(index)" :disabled="index === 0"
                                class="p-1.5 text-slate-400 dark:text-slate-500 hover:text-[#005073] dark:hover:text-[#00bceb] hover:bg-slate-100 dark:hover:bg-slate-700 rounded-md transition disabled:opacity-30 disabled:hover:bg-transparent transition-colors">
        ...
        <div class="w-full">
            <div class="bg-slate-50 dark:bg-slate-900 border-2 border-slate-200 dark:border-slate-800 border-b-8 border-b-[#E2231A] dark:border-b-[#00bceb] rounded-full p-4 flex items-center justify-between shadow-2xl transition-colors duration-300">
                ...
                <button type="submit"
                    class="bg-[#E2231A] dark:bg-[#00bceb] hover:bg-[#be1e16] dark:hover:bg-[#008ebb] text-white dark:text-slate-900 px-10 py-4 rounded-full font-black uppercase tracking-widest text-xs shadow-xl transition-all active:scale-95 transition-colors">
...
<script>
function examBuilder(allStudents, assignedIds) {
